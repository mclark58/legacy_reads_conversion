...
function legacy_reads_conversion(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_legacy_reads_conversion = function (input_params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "legacy_reads_conversion.run_legacy_reads_conversion",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "legacy_reads_conversion.status",
